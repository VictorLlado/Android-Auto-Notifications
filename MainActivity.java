...
public class MainActivity extends Activity {
    ...
    public void sendNotification(View view) {
        ...
        int thisConversationId = 1;
        Intent msgReadIntent = new Intent()
                .addFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES)
                .setAction("com.myapp.android.basicnotifications.MY_ACTION_MESSAGE_HEARD")
        ...
        Intent msgReplyIntent = new Intent()
                .addFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES)
                .setAction("com.myapp.android.basicnotifications.MY_ACTION_MESSAGE_REPLY")
                .putExtra("conversation_id", thisConversationId);
        ...
        String conversationName = "Victor Lladó";
        NotificationCompat.CarExtender.UnreadConversation.Builder unreadConvBuilder = null;
                new NotificationCompat.CarExtender.UnreadConversation.Builder(conversationName);
        unreadConvBuilder.setReadPendingIntent(msgReadPendingIntent);
        unreadConvBuilder.setReplyAction(msgReplyPendingIntent, remoteInput);
